...
export default function Dashboard({ params }) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E14] p-6 pt-12 pb-24 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            {qrDataUrl && (
              <div className="flex justify-center mb-5">
                <div className="p-3 rounded-2xl bg-[#0A0E14]/40 border border-[color:var(--gold)]/30">
        ...
        <div className="glass rounded-3xl p-6 mb-6">
          ...
          <div className="space-y-2 max-h-80 overflow-y-auto no-scrollbar">
            ...
            {invites.map(inv => {
              ...
              return (
                <div key={inv.id} className={`flex items-center gap-2 rounded-xl px-3 py-2 border ${claimed ? 'border-white/5 bg-white/[0.02] opacity-50' : 'border-[color:var(--gold)]/20 bg-[#0A0E14]/30'}`}>
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto no-scrollbar">
            ...
            {attendees.map(a => (
              <div key={a.id} className="flex items-center gap-3 rounded-xl px-3 py-2 border border-white/5 bg-white/[0.02]">
                <div className="w-8 h-8 rounded-full overflow-hidden bg-[#111621] border border-[color:var(--gold)]/20 shrink-0">
                  {a.photo_url
