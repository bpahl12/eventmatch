...
const Shell = ({ children, stepText, title, subtitle }) => (
  <div className="min-h-screen flex flex-col p-6 pt-12 bg-black relative overflow-hidden">
    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(212,175,106,0.08),transparent_60%)] pointer-events-none" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <label className="cursor-pointer">
          <div className={`w-44 h-44 rounded-full border border-[color:var(--gold)]/30 flex items-center justify-center overflow-hidden relative ${form.photoPreview ? 'border-[color:var(--gold)]/60' : ''}`}>
            <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_center,rgba(212,175,106,0.15),transparent_70%)] pulse-glow" />
            {form.photoPreview ? (
